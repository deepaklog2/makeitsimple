...
translations = {
    ...
    'ta': {
        ...
        'risk_of_diabetes': 'உங்களுக்கு சர்க்கரை நோய் வரும் அபாயம் உள்ளது.',
        'no_risk_of_diabetes': 'உங்களுக்கு சர்க்கரை நோய் வரும் அபாயம் இல்லை. உங்கள் ஆரோக்கியத்தை பராமரிக்கும் சிறந்த வேலை!',
        ...
        'risk_of_diabetes_detected': 'நீரிழிவு ஆபத்து கண்டறியப்பட்டது',
        'no_risk_of_diabetes_detected': 'சர்க்கரை நோய் ஆபத்து இல்லை.',
    ...
    'ar': {
        ...
        'diabetes_prediction': 'تنبؤ بالسكري',
        ...
        'insulin': 'الأنسولين',
        'bmi': 'مؤشر كتلة الجسم',
        'diabetes_pedigree_function': 'دالة السلالة للسكري',
        'age': 'العمر',
        'prediction': 'تنبؤ',
        'risk_of_diabetes': 'أنت معرض لخطر الإصابة بالسكري.',
        'no_risk_of_diabetes': 'أنت لست معرضًا لخطر الإصابة بالسكري. استمر في الحفاظ على صحتك!',
        'upload_pdf': 'رفع ملف PDF',
        'choose_pdf': 'اختر ملف PDF',
        'extracted_pdf_data': 'البيانات المستخرجة من PDF',
        'pdf_prediction': 'تنبؤ PDF',
        'risk_of_diabetes_detected': 'تم اكتشاف خطر السكري.',
        'no_risk_of_diabetes_detected': 'لم يتم اكتشاف خطر السكري.',
        'contact_us': 'اتصل بنا',
        'subject': 'الموضوع',
        'message': 'الرسالة',
        'your_email': 'بريدك الإلكتروني',
        'send': 'إرسال',
        'message_prepared': 'تم إعداد رسالتك! يرجى التحقق من وحدة التحكم لمحتوى البريد الإلكتروني.',
